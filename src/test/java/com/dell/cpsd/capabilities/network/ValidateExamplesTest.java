...
package com.dell.converged.capabilities.network;
...
{
    public static final String SCHEMA_DIR   = "/network-capabilities-api/schema/json/";
    public static final String EXAMPLE_DIR  = "/network-capabilities-api/schema/example/";
